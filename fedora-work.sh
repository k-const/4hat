...
firewall-config flatpak gdm gnome-shell gnome-terminal gnome-terminal-nautilus gutenprint-cups \
microsoft-edge-stable nautilus nautilus-extensions nautilus-search-tool thunderbird torbrowser-launcher \
xorg-x11-font-utils
