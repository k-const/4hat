...
firewall-config flatpak gdm gnome-shell gnome-terminal gnome-terminal-nautilus gnome-user-docs \
google-noto-cjk-fonts google-noto-emoji-color-fonts gutenprint-cups microsoft-edge-stable nautilus \
...
qgnomeplatform-qt6 seahorse system-config-printer unifont-fonts usb_modeswitch xorg-x11-font-utils yelp
